                      ...
                      <tr className="hidden md:table-row">
                        ...
                        <td>
                          <div className="flex items-center gap-2">
                            <Button variant="ghost" size="sm" onClick={() => navigate(`/patients/${patient.id}`)} className="h-8 px-2 text-muted-foreground hover:text-primary">
                              <Eye className="w-4 h-4" />
                            </Button>
                            <Button variant="ghost" size="sm" onClick={() => setEditingPatient(patient)} className="h-8 px-2 text-muted-foreground hover:text-primary">
                              <Edit2 className="w-4 h-4" />
                            </Button>
                            <Button variant="ghost" size="sm" onClick={() => setDeletingPatient(patient)} className="h-8 px-2 text-muted-foreground hover:text-destructive">
                      ...
                      <div className="md:hidden flex flex-col p-4 bg-card border border-border rounded-xl shadow-sm mb-4">
                        <div className="flex justify-between items-start mb-3">
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground">{patient.gender} • {formatDate(patient.date_of_birth)}</p>
                          </div>
                        ...
                        <div className="flex items-center gap-2 pt-3 border-t border-border mt-auto">
                          ...
                          <Button variant="outline" size="sm" className="flex-1 text-xs" onClick={() => setEditingPatient(patient)}>
                            Edit
                          </Button>
                          <Button variant="outline" size="sm" className="px-3 text-destructive border-border hover:bg-destructive/10" onClick={() => setDeletingPatient(patient)}>
                            <Trash2 className="w-4 h-4" />
                          </Button>
                        </div>
                      </div>
