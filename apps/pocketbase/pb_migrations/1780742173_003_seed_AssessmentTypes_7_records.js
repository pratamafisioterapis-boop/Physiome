...
migrate((app) => {
  ...
  const record0 = new Record(collection);
    ...
    record0.set("description", "Neck Disability Index");
    record0.set("total_items", 10);
    record0.set("scale_min", 0);
    record0.set("scale_max", 5);
  ...
  const record1 = new Record(collection);
    ...
    record1.set("description", "Oswestry Disability Index");
    record1.set("total_items", 10);
    record1.set("scale_min", 0);
    record1.set("scale_max", 5);
  ...
  const record2 = new Record(collection);
    ...
    record2.set("description", "Disabilities of the Arm, Shoulder and Hand");
    record2.set("total_items", 30);
    record2.set("scale_min", 1);
    record2.set("scale_max", 5);
  ...
  const record3 = new Record(collection);
    ...
    record3.set("description", "Lower Extremity Functional Scale");
    record3.set("total_items", 20);
    record3.set("scale_min", 0);
    record3.set("scale_max", 4);
  ...
  const record4 = new Record(collection);
    ...
    record4.set("description", "Western Ontario and McMaster Universities Osteoarthritis Index");
    record4.set("total_items", 24);
    record4.set("scale_min", 0);
    record4.set("scale_max", 4);
  ...
  const record5 = new Record(collection);
    ...
    record5.set("description", "Knee Injury and Osteoarthritis Outcome Score");
    record5.set("total_items", 42);
    record5.set("scale_min", 0);
    record5.set("scale_max", 4);
  ...
  const record6 = new Record(collection);
    ...
    record6.set("description", "Hip Disability and Osteoarthritis Outcome Score");
    record6.set("total_items", 40);
    record6.set("scale_min", 0);
    record6.set("scale_max", 4);
