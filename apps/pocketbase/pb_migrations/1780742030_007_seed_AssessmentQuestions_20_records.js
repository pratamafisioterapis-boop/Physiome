...
migrate((app) => {
  ...
  const record0 = new Record(collection);
    ...
    record0.set("question_text", "Any difficulty to do light activities in a house (dusting, washing dishes)?");
  ...
  const record1 = new Record(collection);
    ...
    record1.set("question_text", "Any difficulty to do heavy household chores (scrubbing floors, lifting boxes)?");
  ...
  const record2 = new Record(collection);
    ...
    record2.set("question_text", "Any difficulty to do grocery shopping on your own?");
  ...
  const record3 = new Record(collection);
    ...
    record3.set("question_text", "Any difficulty to get into or out of the bathtub?");
  ...
  const record4 = new Record(collection);
    ...
    record4.set("question_text", "Any difficulty to walk for a mile?");
  ...
  const record5 = new Record(collection);
    ...
    record5.set("question_text", "Any difficulty to walk for several blocks?");
  ...
  const record6 = new Record(collection);
    ...
    record6.set("question_text", "Any difficulty to climb a flight of stairs?");
  ...
  const record7 = new Record(collection);
    ...
    record7.set("question_text", "Any difficulty to climb up or down curbs?");
  ...
  const record8 = new Record(collection);
    ...
    record8.set("question_text", "Any difficulty to walk on uneven surfaces?");
  ...
  const record9 = new Record(collection);
    ...
    record9.set("question_text", "Any difficulty to keep up with others on foot?");
  ...
  const record10 = new Record(collection);
    ...
    record10.set("question_text", "Any difficulty to go up or down stairs at a normal pace?");
  ...
  const record11 = new Record(collection);
    ...
    record11.set("question_text", "Any difficulty to stand on your tiptoes?");
  ...
  const record12 = new Record(collection);
    ...
    record12.set("question_text", "Any difficulty to stand on one leg?");
  ...
  const record13 = new Record(collection);
    ...
    record13.set("question_text", "Any difficulty to bend down and pick up an object from the floor?");
  ...
  const record14 = new Record(collection);
    ...
    record14.set("question_text", "Any difficulty to get into or out of a car?");
  ...
  const record15 = new Record(collection);
    ...
    record15.set("question_text", "Any difficulty to put on shoes or socks?");
  ...
  const record16 = new Record(collection);
    ...
    record16.set("question_text", "Any difficulty to squat?");
  ...
  const record17 = new Record(collection);
    ...
    record17.set("question_text", "Any difficulty to sit on your heels?");
  ...
  const record18 = new Record(collection);
    ...
    record18.set("question_text", "Any difficulty to sit in a chair for one hour?");
  ...
  const record19 = new Record(collection);
    ...
    record19.set("question_text", "Any difficulty to stand for one hour?");
